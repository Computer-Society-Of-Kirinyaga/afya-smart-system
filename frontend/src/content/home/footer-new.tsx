        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-24">
          <div className="lg:col-span-3">
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              Reimagining the patient experience through technology, design, and compassion.
            </p>
          </div>
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4">
              {['Primary Care', 'Cardiology', 'Pediatrics', 'Urgent Care'].map((item) => (
                <li key={item}>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4">
              {['Portal Login', 'Pay Bill', 'Insurance', 'Privacy Policy'].map((item) => (
                <li key={item}>
                  <a className="text-sm text-slate-500 hover:text-teal-600 transition-colors" href="#">
                    {item}
                  </a>
