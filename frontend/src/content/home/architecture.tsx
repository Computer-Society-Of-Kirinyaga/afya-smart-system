      ...
      <div className="px-6 lg:px-[6%] max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Built on a scalable, secure cloud infrastructure with world-class data protection
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-4 gap-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 text-center">
            ...
            <p className="text-xs text-slate-500 mt-2">ECG, BP, SpO2, Glucose</p>
          </div>
        ...
        <div className="mt-16 bg-slate-50 border border-slate-200 rounded-lg p-8">
          <h3 className="font-semibold text-slate-900 mb-6 text-center">Enterprise Security</h3>
          <div className="grid lg:grid-cols-3 gap-8">
            <div>
              <div className="font-semibold text-slate-900 mb-2">🔐 HIPAA Compliant</div>
              <p className="text-sm text-slate-600">Full HIPAA compliance with audit trails</p>
            </div>
            <div>
              <div className="font-semibold text-slate-900 mb-2">🔒 End-to-End Encryption</div>
              <p className="text-sm text-slate-600">256-bit AES encryption in transit and at rest</p>
            </div>
            <div>
              <div className="font-semibold text-slate-900 mb-2">✅ SOC 2 Certified</div>
              <p className="text-sm text-slate-600">Type II certification with continuous monitoring</p>
            </div>
          </div>
        </div>
      </div>
